...
if (isset($_POST['submit'])) {
        ...
        $q = "UPDATE `services` SET title='$title', description='$con_desc', service_image='$filevalue', h1='$h1', meta_title='$meta_title', meta_description='$meta_description' where id='$service_id'";
        // var_dump($q);
