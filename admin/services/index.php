...
if (isset($_GET['id'])) {
    if (!empty($_GET['id'])) {
        mysqli_query($con, "DELETE FROM `services` where id={$_GET['id']}");
        echo "<script>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <a class="dropdown-item fs-sm" href="<?php echo ADMIN_URL; ?>services/add.php">
                    <h5 class="card-title float-end btn bg-success text-white">Add New Service</h5>
                </a>
            ...
            <div class="card-body">
                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $fetching_data = mysqli_query($con, "SELECT * FROM services order by id desc");
                        ...
                        ?>
                            <tr>
                                ...
                                if (!empty($row['service_image'])) {
                                    echo '<img src="../uploads/images/' . $row['service_image'] . '" class="img-thumbnail mt-2" width="100" height="100">';
                                }
                                ?></td>
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item edit-item-btn" href="<?php echo ADMIN_URL; ?>services/edit.php?id='<?php echo $row['id']; ?>'"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                    Edit</a>
                                            </li>
                                            <li>
                                                <input type="hidden" value="<?php echo ADMIN_URL; ?>services/index.php?id='<?php echo $row['id']; ?>'" id="delete_id">
