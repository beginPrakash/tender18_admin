...
if (isset($_POST['btnInsert'])) {
    ...
    $q1 = "UPDATE `smtp_management` SET `host`='$host', `user_name`='$user_name', `password`='$password', `port`='$port', `from_email`='$from_email', `from_name`='$from_name' WHERE `id`=1";
    ...
    echo "
             ...
             <script>
                     ...
                     setTimeout(function(){
                        ...
                        window.location.href='" . ADMIN_URL . "/smtp_mgmt/index.php';
...
<div class="row">
    ...
    <div class="col-12">
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <h4 class="mb-sm-0">SMTP management</h4>
...
$header_data = mysqli_query($con, "SELECT * FROM `smtp_management`");
        ...
        <div class="card">
            ...
            <form action="" method="post" id="smtp_form">
                ...
                <div class="card-header">
                    ...
                    <h4 class="card-title mb-0">SMTP Management</h4>
