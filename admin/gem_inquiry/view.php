...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Inquiry Details</h4>
        </div>
    </div>
</div>
<!-- end page title -->
...
$banner_data = mysqli_query($con, "SELECT * FROM `gem_inquiries` where id='" . $id . "'");
...
if ($banner_result == 1) {
    while ($row = mysqli_fetch_assoc($banner_data)) {
        ...
        $gem_state_city = $row['gem_state_city'];
    }
}
?>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row gy-4">
                    ...
                    <div class="col-xxl-12 col-md-12">
                        <div class="col-md-6">
                            <label for="name" class="form-label"><b>GEM State/City :</b></label> <?php echo $gem_state_city; ?>
                        </div>
                    </div>
