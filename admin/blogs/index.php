            ...
            <div class="card-body">
                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $fetching_data = mysqli_query($con, "SELECT * FROM blogs order by id desc");
                        ...
                        ?>
                            <tr>
                                ...
                                if (!empty($row['blog_image'])) {
                                    echo '<img src="../uploads/images/' . $row['blog_image'] . '" class="img-thumbnail mt-2" width="100" height="100">';
                                }
                                ?></td>
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item edit-item-btn" href="<?php echo ADMIN_URL; ?>blogs/edit.php?id='<?php echo $row['id']; ?>'"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                    Edit</a>
                                            </li>
                                            <li>
                                                <input type="hidden" value="<?php echo ADMIN_URL; ?>blogs/index.php?id='<?php echo $row['id']; ?>'" id="delete_id">
