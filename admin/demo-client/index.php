...
}elseif($_SESSION['role']=='employee' && $democlients_per!=1){ 
    // echo "not admin ------>" . $_SESSION['role'];
    echo "<script>
            window.location.href='../index.php';
            </script>";
...
if (isset($_GET['id'])) {
    if (!empty($_GET['id'])) {
        mysqli_query($con, "DELETE FROM `demo_client` where id={$_GET['id']}");
        echo "<script>
            window.location.href='" . ADMIN_URL . "demo-client/index.php';
            </script>";
    }
}
?>
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Demo Clients</h4>
        </div>
            ...
            <div class="card-body">
                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $fetching_data = mysqli_query($con, "SELECT * FROM demo_client order by id desc");
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item edit-item-btn" href="<?php echo ADMIN_URL; ?>clients/add.php?cid='<?php echo $row['id']; ?>'"><i class="ri-add-circle-fill align-bottom me-2 text-muted"></i>
                                                    Add to main Client</a>
                                            </li>
                                            <li>
                                                <input type="hidden" value="<?php echo ADMIN_URL; ?>demo-client/index.php?id='<?php echo $row['id']; ?>'" id="delete_id">
