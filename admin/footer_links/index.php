...
}elseif($_SESSION['role']=='employee' && $footer_link_per!=1){ 
    // echo "not admin ------>" . $_SESSION['role'];
    echo "<script>
            window.location.href='../index.php';
            </script>";
...
if (isset($_GET['id'])) {
    if (!empty($_GET['id'])) {
        mysqli_query($con, "DELETE FROM `footer_links` where id={$_GET['id']}");
        echo "<script>
            window.location.href='" . ADMIN_URL . "footer_links/index.php';
            </script>";
    }
}
?>
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Footer Links</h4>
        </div>
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item edit-item-btn" href="<?php echo ADMIN_URL; ?>footer_links/edit.php?id='<?php echo $row['id']; ?>'"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                    Edit</a>
                                            </li>
                                            <li>
                                                <input type="hidden" value="<?php echo ADMIN_URL; ?>footer_links/index.php?id='<?php echo $row['id']; ?>'" id="delete_id">
