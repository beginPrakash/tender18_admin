...
if (isset($_POST['btnInsert'])) {
    ...
    $q1 = "UPDATE `footer_links` SET `main_title`='$main_title', `title_url`='$link_arr',`more_link_url`='$more_link_url' WHERE `id`= {$_GET['id']}";
...
$header_data = mysqli_query($con, "SELECT * FROM `footer_links` where `id`={$_GET['id']}");
...
if ($header_result == 1) {
    ...
    while ($row = mysqli_fetch_assoc($header_data)) {
        ...
        $more_link_url = $row['more_link_url'];
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xxl-12 col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="more_link_url" class="form-label">View More Link URL </label>

                                <input class="form-control" type="text" name="more_link_url" id="more_link_url" value="<?php echo $more_link_url; ?>">
