...
if (isset($_POST['btnInsert'])) {
    ...
    $q1 = "INSERT INTO footer_links(`main_title`,`title_url`,`more_link_url`) VALUES ('$main_title','$link_arr','$more_link_url')";
        ...
        <div class="card">
            ...
            <form action="" method="post" id="smtp_form">
                ...
                <div class="card-header">
                    ...
                    <h4 class="card-title mb-0">Footer Links</h4>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xxl-12 col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" name="more_link_url" id="more_link_url">
