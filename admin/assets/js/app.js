      ...
      if (screen.width > 1024) {
        switch (e["data-sidebar-size"]) {
          ...
          case "sm-hover":
            ...
            break
          default:
            T("data-sidebar-size", "sm-hover-active")
        }
      } else {
        switch (e["data-sidebar-size"]) {
          case "lg":
