...
<form id="amovepostForm" method="POST" action="" style="display:none;">
    <input type="hidden" name="amove"value="">
</form>
<!-- end page title -->
        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="row mb-4">
                    ...
                    <div class="col col-2 float-end">
                        <a href="#" class="amove" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center-02">
                                    ...
                                    <div class="modal-body text-center p-5">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="hstack gap-2 justify-content-center">
                                                ...
                                                <a href="javascript:void(0);" class="btn btn-danger" onclick="document.getElementById('amovepostForm').submit(); return false;">Move</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
