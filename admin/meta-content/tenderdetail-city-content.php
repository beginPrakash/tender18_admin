...
$pages = 'tenderdetail-city-content';
?>
...
if (isset($_POST['btnInsert'])) {
    ...
    $q1 = "UPDATE `tender_detail_content` SET `type`='city', `content`='$content' WHERE `id`=2";
    ...
    echo "
             ...
             <script>
                     ...
                     setTimeout(function(){
                        ...
                        window.location.href='" . ADMIN_URL . "/meta-content/tenderdetail-city-content.php';
...
<div class="row">
    ...
    <div class="col-12">
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <h4 class="mb-sm-0">Tender Detail City Content</h4>
...
$header_data = mysqli_query($con, "SELECT * FROM `tender_detail_content` where `id`= 2");
        ...
        <div class="card">
            ...
            <form action="" method="post" id="keyword_content_form">
                ...
                <div class="card-header">
                    ...
                    <h4 class="card-title mb-0">Tender Detail City Content</h4>
