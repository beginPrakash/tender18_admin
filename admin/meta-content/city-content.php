...
if (isset($_POST['btnInsert'])) {
    ...
    foreach ($terms_details_title as $key => $title) {
        if (!empty($title)) {
            ...
            $q = "INSERT INTO faq_meta(`title`, `description`,`type`) VALUES ('$title', '$desc','city_page')";
    ...
    echo "
             ...
             <script>
                     ...
                     setTimeout(function(){
                        ...
                        window.location.href='" . ADMIN_URL . "/meta-content/city-content.php';
...
$content_data = mysqli_query($con, "SELECT * FROM `tenderdetail_page_meta_content` where `type` = 'city_page'");
        ...
        <div class="card">
            ...
            <form action="" method="post" id="city_content_form">
                ...
                <div class="card-body details_banner_section terms_details">
                    <div class="row gy-4">
                        <?php
                        $terms_details_data = mysqli_query($con, "SELECT * FROM `faq_meta` where `type`='city_page'");
