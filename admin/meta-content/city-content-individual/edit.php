...
?>
<?php
$city_content_individual_per = _get_user_perby_role($_SESSION['user_id'],'city_content_individual',$con);
...
}elseif($_SESSION['role']=='employee' && $city_content_individual_per!=1){ 
    // echo "not admin ------>" . $_SESSION['role'];
    echo "<script>
            window.location.href='../index.php';
            </script>";
