...
$pages = 'tenderdetail-agency-content';
?>
...
if (isset($_POST['btnInsert'])) {
    ...
    $q1 = "UPDATE `tender_detail_content` SET `type`='agency', `content`='$content' WHERE `id`=1";
    ...
    echo "
             ...
             <script>
                     ...
                     setTimeout(function(){
                        ...
                        window.location.href='" . ADMIN_URL . "/meta-content/tenderdetail-agency-content.php';
...
<div class="row">
    ...
    <div class="col-12">
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <h4 class="mb-sm-0">Tender Detail Agency Content</h4>
...
$header_data = mysqli_query($con, "SELECT * FROM `tender_detail_content` where `id`= 1");
        ...
        <div class="card">
            ...
            <form action="" method="post" id="keyword_content_form">
                ...
                <div class="card-header">
                    ...
                    <h4 class="card-title mb-0">Tender Detail Agency Content</h4>
