...
$pages = 'tenderdetail-page-meta-content';
?>
...
if (isset($_POST['btnInsert'])) {
    ...
    $q1 = "UPDATE `tenderdetail_page_meta_content` SET `title`='$title', `description`='$description', `keywords`='$keywords', `h1`='$h1', `content`='$content', `tab_title`='$tab_title', `tab_description`='$tab_description', `tab_title2`='$tab_title2', `tab_description2`='$tab_description2', `tab_title3`='$tab_title3', `tab_description3`='$tab_description3', `tab_title4`='$tab_title4', `tab_description4`='$tab_description4', `faq_main_title` = '$faq_main_title' WHERE `type`='tender_detail'";
    ...
    foreach ($terms_details_title as $key => $title) {
        if (!empty($title)) {
            ...
            $q = "INSERT INTO faq_meta(`title`, `description`,`type`) VALUES ('$title', '$desc','tender_detail')";
    ...
    echo "
             ...
             <script>
                     ...
                     setTimeout(function(){
                        ...
                        window.location.href='" . ADMIN_URL . "/meta-content/tenderdetail-page-meta-content.php';
...
<div class="row">
    ...
    <div class="col-12">
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <h4 class="mb-sm-0">Tender Detail Page Meta Content</h4>
...
$header_data = mysqli_query($con, "SELECT * FROM `tenderdetail_page_meta_content` where `type` = 'tender_detail'");
...
<div class="row">
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            ...
            <form action="" method="post" id="tenderdetail_content_form">

                <div class="card-header">

                    <h4 class="card-title mb-0">Tender Detail Page Meta Content</h4>
                ...
                <div class="card-body details_banner_section terms_details">
                    <div class="row gy-4">
                        <?php
                        $terms_details_data = mysqli_query($con, "SELECT * FROM `faq_meta` where `type`='tender_detail'");
...
<script>
    $(document).ready(function() {
        $('#tenderdetail_content_form').validate({
            rules: {
                'title': "required",
        ...
        $('#tenderdetail_content_form').submit(function(event) {
