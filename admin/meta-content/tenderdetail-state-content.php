...
$pages = 'tenderdetail-state-content';
?>
...
if (isset($_POST['btnInsert'])) {
    ...
    $q1 = "UPDATE `tender_detail_content` SET `type`='state', `content`='$content' WHERE `id`=3";
    ...
    echo "
             ...
             <script>
                     ...
                     setTimeout(function(){
                        ...
                        window.location.href='" . ADMIN_URL . "/meta-content/tenderdetail-state-content.php';
...
<div class="row">
    ...
    <div class="col-12">
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <h4 class="mb-sm-0">Tender Detail State Content</h4>
...
$header_data = mysqli_query($con, "SELECT * FROM `tender_detail_content` where `id`= 3");
        ...
        <div class="card">
            ...
            <form action="" method="post" id="keyword_content_form">
                ...
                <div class="card-header">
                    ...
                    <h4 class="card-title mb-0">Tender Detail State Content</h4>
