...
if (!empty($_SESSION['success'])) {
    ...
    echo "
             <script>
                     setTimeout(function(){
                        window.location.href='" . ADMIN_URL . "/keyword-tenders/index.php';
                                ...
                                <tr class="<?php if ($i % 2 == 0) {
                                    ...
                                    <td class="action_element">
                                        <div class="d-flex align-items-center">
                                            <a href="<?php echo ADMIN_URL; ?>keyword-tenders/view.php?id=<?php echo $source['_id']; ?>"><i style="font-size: 20px;" class="ri-eye-fill text-success"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php $i++;
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7">
                        ...
                        if ($total > 1) {
                            ...
                            if ($page > 1) {
                                $data .= '<li class="paginate_button page-item previous"><a class="page-link" href="' . ADMIN_URL . 'keyword-tenders/index.php' . '?page_no=' . ($page - 1) . '">Previous</a></li>';
                            }
                            // display the "previous" link
                            if ($page == 2) {
                                $data .= '<li class="paginate_button page-item"><a href="' . ADMIN_URL . 'keyword-tenders/index.php' . '?page_no=1" class="page-link">' . ($page - 1) . '</a></li>';
                            }
                            // display the first page link
                            if ($page > 2) {
                                $data .= '<li class="paginate_button page-item"><a href="' . ADMIN_URL . 'keyword-tenders/index.php' . '?page_no=1" class="page-link">1</a></li>';
                            ...
                            for ($i = max(2, $page - 2); $i < $page; $i++) {
                                $data .= '<li class="paginate_button page-item"><a href="' . ADMIN_URL . 'keyword-tenders/index.php' . '?page_no=' . $i . '" class="page-link">' . $i . '</a></li>';
                            }
                            ...
                            if ($page < $total - 1) {
                                ...
                                $data .= '<li class="paginate_button page-item"><a href="' . ADMIN_URL . 'keyword-tenders/index.php' . '?page_no=' . $total . '" class="page-link">' . $total . '</a></li>';
                            }
                            // display the "next" link
                            if ($page == $total - 1) {
                                $data .= '<li class="paginate_button page-item"><a href="' . ADMIN_URL . 'keyword-tenders/index.php' . '?page_no=' . ($page + 1) . '" class="page-link">' . ($total) . '</a></li>';
                            }
                            // display the "next" link
                            if ($page < $total) {
                                $data .= '<li class="paginate_button page-item next"><a class="page-link" href="' . ADMIN_URL . 'keyword-tenders/index.php' . '?page_no=' . ($page + 1) . '">Next</i></a></li>';
                            }
                            $data .= '</ul></div>';
                            echo $data;
                        }
