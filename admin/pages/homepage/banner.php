...
if (isset($_POST['submit'])) {
    ...
    $q = "INSERT INTO homepage_banner(`title`, `description` ,`image`) VALUES ('$title', '$description', '$filevalue')";
    ...
    foreach ($details_title as $key => $title) {
        if (!empty($title)) {
            ...
            $q = "INSERT INTO homepage_banner_details(`title`, `sub_title` ,`image`) VALUES ('$title', '$details_sub_title[$key]', '$filevalue1')";
            ...
            <form action="" method="post" <?php if ($banner_result == 1) {
                ...
                <div class="card-body">
                    <div class="row gy-4">
                        ...
                        <div class="col-xxl-12 col-md-12">
                            <div class="col-md-6">
                                <label for="image" class="form-label">Banner Image: <?php if ($banner_result < 1) {
                                ...
                                <?php
                                if (!empty($image)) {
                                    echo '<img src="../images/' . $image . '" class="img-thumbnail mt-2" width="100" height="100">';
                                }
                                ?>
                            </div>
                        </div>
                    ...
                    <div class="row gy-4">
                        ...
                        if ($banner_details_result > 0) {
                            while ($row = mysqli_fetch_assoc($banner_details_data)) {
                                ...
                                $details_sub_title = $row['sub_title'];
