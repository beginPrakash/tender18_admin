...
if (isset($_POST['submit'])) {
    ...
    $query_delete1 = mysqli_query($con, "DELETE FROM `all_tenders_banner`");
    $q1 = "INSERT INTO all_tenders_banner(`title`, `image`, `main_title`) VALUES ('$banner_title', '$filevalue', '$main_title')";
...
if (!empty($_SESSION['success'])) {
    ...
    echo "
             <script>
                     setTimeout(function(){
                        window.location.href='" . ADMIN_URL . "/pages/all-tenders/index.php';
...
$banner_data = mysqli_query($con, "SELECT * FROM `all_tenders_banner`");
