...
if (isset($_POST['submit'])) {
    ...
    $query_delete = mysqli_query($con, "DELETE FROM `partners`");

    foreach ($_FILES['details_image']['name'] as $key => $file_name) {
        ...
        $q = "INSERT INTO partners(`image`) VALUES ('$filevalue1')";
...
$banner_details_data = mysqli_query($con, "SELECT * FROM `partners`");
        ...
        <div class="card">
            <form action="" method="post" id="homepage_service" enctype="multipart/form-data">
                <div class="card-header">
                    <h4 class="card-title mb-0">Partners Section</h4>
                </div>
                <div class="ps-3">
                                    ...
                                    <div class="col-xxl-6 col-md-6 bg-light pt-3 pb-4 ps-2 pe-2">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            if (!empty($details_image)) {
                                                echo '<img src="../../uploads/images/' . $details_image . '" class="img-thumbnail mt-2" width="100" height="100">';
                                            }
                                            ?>
                                        </div>
                                    </div>
...
<script>
    $("#add_more").click(function() {
        if ($(".details-block").length < 100) {
            ...
            i = i + 1;
            var html = '<div class="details-block col-xxl-12 col-md-12 mt-4" data-id="' + i + '"><div class="col-xxl-6 col-md-6 bg-light pt-3 pb-4 ps-2 pe-2"><i class="ri-delete-bin-5-fill remove"></i><div class="col-md-6 mt-3"><label for="details_image" class="form-label">Image: <span class="text-danger">*</span></label><input class="form-control" type="file" name="details_image[]" id="details_image"></div></div></div>';
