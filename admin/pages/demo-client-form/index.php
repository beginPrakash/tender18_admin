...
if (isset($_POST['submit'])) {
    ...
    foreach ($why_details_title as $key => $why_title) {
        if (!empty($why_title)) {
            ...
            $q = "INSERT INTO client_demo_why_details(`title`, `icon`) VALUES ('$why_title', '$why_description')";
            // var_dump($q);
...
if (!empty($_SESSION['success'])) {
    ...
    echo "
             <script>
                     setTimeout(function(){
                        window.location.href='" . ADMIN_URL . "/pages/demo-client-form/index.php';
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Demo Client Form Data</h4>
        </div>
    </div>
</div>
<!-- end page title -->
