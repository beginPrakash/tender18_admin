...
if (isset($_POST['submit'])) {
        ...
        $q1 = "UPDATE `tenderdetail_page_meta_content` SET `faq_main_title` = '$faq_main_title' WHERE `type`='gem_state_page'";

        $sql1 = mysqli_query($con, $q1);

        $query_delete2 = mysqli_query($con, "DELETE FROM `faq_meta` where type='gem_state_page'");
        ...
        foreach ($terms_details_title as $key => $title) {
            if (!empty($title)) {
                ...
                $q = "INSERT INTO faq_meta(`title`, `description`,`type`) VALUES ('$title', '$desc','gem_state_page')";
                $sql = mysqli_query($con, $q);
            }
        }
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            $header_data = mysqli_query($con, "SELECT * FROM `tenderdetail_page_meta_content` where `type` = 'gem_state_page'");
                ...
                <div class="card-body">
                    <div class="row gy-4">
                        ...
                        <div class="card-body details_banner_section terms_details">
                            <div class="row gy-4">
                                <?php
                                $terms_details_data = mysqli_query($con, "SELECT * FROM `faq_meta` where `type`='gem_state_page'");
