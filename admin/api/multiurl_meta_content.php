...

{
    ...
    if(!empty($meta_arr) && !empty($agencymeta_arr)){
        ...
        $final_h1 = highlight_keywords_in_text($final_h1, $metaAgency);
        $final_content = highlight_keywords_in_text($final_content, $metaAgency);
        
        $final_h1 = highlight_keywords_in_text($final_h1, $metaState);
        $final_content = highlight_keywords_in_text($final_content, $metaState);
        ...
        $final_h1 = highlight_keywords_in_text($final_h1, $metaCity);
        $final_content = highlight_keywords_in_text($final_content, $metaCity);
        ...
        $final_h1 = highlight_keywords_in_text($final_h1, $metaSource);
        $final_content = highlight_keywords_in_text($final_content, $metaSource);
        ...
        // Highlight in h1 and content
        $final_h1 = highlight_keywords_in_text($final_h1, $metaKeyword);
        $final_content = highlight_keywords_in_text($final_content, $metaKeyword);
        ...
        // Highlight in h1 and content
        $final_h1 = highlight_keywords_in_text($final_h1, $metaTenderType);
        $final_content = highlight_keywords_in_text($final_content, $metaTenderType);
        ...
        // Highlight in h1 and content
        $final_h1 = highlight_keywords_in_text($final_h1, $metaTender_Type);
        $final_content = highlight_keywords_in_text($final_content, $metaTender_Type);
