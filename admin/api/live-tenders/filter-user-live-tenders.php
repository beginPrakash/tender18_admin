...
switch ($endpoint) {
    ...
    case 'getFilterUserLiveTendersData':
...

{
    ...
    if(!empty($keyw)):
        // $tender_data = mysqli_query($con, "SELECT `ref_no`,`department`,`city`,`state`,`pincode`,`title`,`agency_type`,`publish_date`,`due_date`,`tender_value`,`tender_fee`,`tender_emd` FROM `tenders_live` $condition $condition_filter $condition_orderque LIMIT $offset, $limit");

        $tender_data = mysqli_query($con, "(SELECT * FROM `tenders_live` $condition $condition_filter) UNION ALL (SELECT * FROM `tenders_live` $condition_u $condition_filter) $condition_orderque LIMIT $offset, $limit");
        ...
        if(!empty($keywords)):
            $tender_data = mysqli_query($con, "SELECT `ref_no`,`department`,`city`,`state`,`pincode`,`title`,`agency_type`,`publish_date`,`due_date`,`tender_value`,`tender_fee`,`tender_emd` FROM `tenders_live` $condition $condition_filter $condition_orderque_key LIMIT $offset, $limit");

            // $tender_data = mysqli_query($con, "SELECT * FROM `tenders_live` $condition $condition_filter $condition_orderque_key LIMIT $offset, $limit");

        

        else:
            $tender_data = mysqli_query($con, "SELECT `ref_no`,`department`,`city`,`state`,`pincode`,`title`,`agency_type`,`publish_date`,`due_date`,`tender_value`,`tender_fee`,`tender_emd` FROM `tenders_live` $condition $condition_filter $condition_orderque order by publish_date desc LIMIT $offset, $limit");
    ...
    //echo "(SELECT * FROM `tenders_live` $condition $condition_filter) UNION ALL (SELECT * FROM `tenders_live` $condition_u $condition_filter) $condition_orderque LIMIT $offset, $limit";
