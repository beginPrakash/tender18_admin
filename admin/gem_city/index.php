...
?>
<?php
$gemcity_per = _get_user_perby_role($_SESSION['user_id'],'gem_city',$con);
...
}elseif($_SESSION['role']=='employee' && $gemcity_per!=1){ 
    // echo "not admin ------>" . $_SESSION['role'];
    echo "<script>
            window.location.href='../index.php';
            </script>";
...
if (isset($_GET['id']) && isset($_GET['unique_code'])) {
    if (empty($_GET['id'])) {
        echo "<script>
            window.location.href='" . ADMIN_URL . "gem_city/index.php';
            </script>";
    }
}
?>
...
if (isset($_POST['submit'])) {
        ...
        $q1 = "UPDATE `tenderdetail_page_meta_content` SET `faq_main_title` = '$faq_main_title' WHERE `type`='gem_city_page'";

        $sql1 = mysqli_query($con, $q1);

        $query_delete2 = mysqli_query($con, "DELETE FROM `faq_meta` where type='gem_city_page'");
        ...
        foreach ($terms_details_title as $key => $title) {
            if (!empty($title)) {
                ...
                $q = "INSERT INTO faq_meta(`title`, `description`,`type`) VALUES ('$title', '$desc','gem_city_page')";
                $sql = mysqli_query($con, $q);
            }
        }
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">GEM Cities Data</h4>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <?php $fetch_data = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM `gem_city_data` where id=1"));

            $header_data = mysqli_query($con, "SELECT * FROM `tenderdetail_page_meta_content` where `type` = 'gem_city_page'");
            ...
            ?>
            <form action="" method="post" id="gemcity_form" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row gy-4">
                        ...
                        <div class="col-xxl-12 col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="title" placeholder="Enter Title " class="form-control" id="title" value="<?php echo $fetch_data['title']; ?>">
                            </div>
                        </div>
                        <div class="col-xxl-12 col-md-12">
                            <div class="col-md-6">
                                <label for="description" class="form-label">Description : <span class="text-danger">*</span></label>
                                <textarea rows="5" name="description" class="form-control d-none" id="description"><?php echo $fetch_data['description']; ?></textarea>
                                <div class="ckeditor-classic-total ckeditor-classic-job-profile"><?php echo $fetch_data['description']; ?></div>
                            </div>
                        </div>
                        <div class="col-xxl-12 col-md-12">
                            <div class="col-md-6">
                                <label for="city_image" class="form-label">City Image:</label>
                                <input class="form-control" type="file" name="city_image" id="city_image">
                                <?php $city_image = $fetch_data['city_image']; ?>
                                <input type="hidden" name="hidden_city_image" value="<?php echo $city_image; ?>">
                                <?php
                                
                                if (!empty($city_image)) {
                                    echo '<img src="../uploads/images/' . $city_image . '" class="img-thumbnail mt-2" width="100" height="100">';
                                }
                                ?>
                            </div>
                        </div>
                        <div class="col-xxl-12 col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="h1" placeholder="Enter H1 " class="form-control" id="h1" value="<?php echo $fetch_data['h1']; ?>">
                            </div>
                        </div>
                        <div class="col-xxl-12 col-md-12">
                            <div class="col-md-6">
                                <label for="meta_title" class="form-label">Meta Title : </label>
                                <input type="text" name="meta_title" placeholder="Enter Meta Title " class="form-control" id="meta_title" value="<?php echo $fetch_data['meta_title']; ?>">
                            </div>
                        </div>
                        <div class="col-xxl-12 col-md-12">
                            <div class="col-md-6">
                                <label for="meta_description" class="form-label">Meta Description : </label>
                                <textarea rows="5" name="meta_description" class="form-control" id="meta_description"><?php echo $fetch_data['meta_description']; ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-12 col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" name="main_title" id="main_title" value="<?php echo $fetch_data['main_title']; ?>">


                            </div>
                            <div class="col-md-6">

                                <label for="more_link_url" class="form-label">More Link Url</label>

                                <input class="form-control" type="text" name="more_link_url" id="more_link_url" value="<?php echo $fetch_data['more_link_url']; ?>">
                        ...
                        <div class="col-xxl-12 col-md-12">
                            ...
                            <div class="row link_table_data">
                                <table class="link_table">
                                    <?php $title_url = json_decode($fetch_data['title_urls']); ?>
                                    <?php $i = 0; ?>
                        ...
                        <div class="col-xxl-12 col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" name="main_title1" id="main_title1" value="<?php echo $fetch_data['main_title1']; ?>">


                            </div>
                            <div class="col-md-6">

                                <label for="more_link_url1" class="form-label">More Link Url</label>

                                <input class="form-control" type="text" name="more_link_url1" id="more_link_url1" value="<?php echo $fetch_data['more_link_url1']; ?>">
                        ...
                        <div class="col-xxl-12 col-md-12">
                            ...
                            <div class="row link_table_data1">
                                <table class="link_table1">
                                    <?php $title_url1 = json_decode($fetch_data['title_urls1']); ?>
                                    <?php $i = 0; ?>
                        ...
                        <div class="col-xxl-12 col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" type="text" name="main_title2" id="main_title2" value="<?php echo $fetch_data['main_title2']; ?>">


                            </div>
                            <div class="col-md-6">

                                <label for="more_link_url2" class="form-label">More Link Url</label>

                                <input class="form-control" type="text" name="more_link_url2" id="more_link_url2" value="<?php echo $fetch_data['more_link_url2']; ?>">
                        ...
                        <div class="col-xxl-12 col-md-12">
                            ...
                            <div class="row link_table_data2">
                                <table class="link_table2">
                                    <?php $title_url2 = json_decode($fetch_data['title_urls2']); ?>
                                    <?php $i = 0; ?>
                        ...
                        <div class="card-body details_banner_section terms_details">
                            <div class="row gy-4">
                                <?php
                                $terms_details_data = mysqli_query($con, "SELECT * FROM `faq_meta` where `type`='gem_city_page'");
...
<script>
    $(document).ready(function() {
        ...
        $('#gemcity_form').submit(function(event) {
