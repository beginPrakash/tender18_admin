                ...
                <div class="row">
                    <div class="col-2">
                        <a class="dropdown-item fs-sm" href="<?php echo ADMIN_URL; ?>clients/active.php">
                            <h5 class="card-title btn w-100 bg-success text-white">Active</h5>
                        </a>
                    </div>
                    <div class="col-2">
            ...
            <div class="card-body">
                ...
                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%">
                    ...
                    <tbody>
                        ...
                        $i = 1;
                        $fetching_users = mysqli_query($con, "SELECT * FROM users where user_role='user' and `status`='Active' order by user_id desc");
