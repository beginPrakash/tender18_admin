                    ...
                    $(document).ready(function () {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                setTimeout(function(){ window.location.href="' . ADMIN_URL . '/zipcodes"; }, 2000);
                            }
                        });
                    });
                </script>';
                        ...
                        ?>
                                <tr class="<?php if ($i % 2 == 0) {
                                    ...
                                    <td class="action_element">
                                        ...
                                        <a href="<?php echo ADMIN_URL; ?>zipcodes?id=<?php echo $data['id']; ?>" class="delete" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center"><i style="font-size: 20px;" class="ri-delete-bin-fill text-danger"></i></a>
                                    </td>
                                </tr>
                            <?php $i++;
                            }
