...
if (isset($_GET['id'])) {
    ...
    $del = mysqli_query($con, "DELETE FROM `tender_zipcodes` where id='" . $_GET['id'] . "'");
...
if (isset($_POST['submit_excel'])) {
    ...
    if (isset($_FILES['excel_file']) && $_FILES['excel_file']['error'] === UPLOAD_ERR_OK) {
        ...
        $uploadDirectory = '../uploads/zipcode_uploads/';
        ...
        if (in_array($fileExt, ['xls', 'xlsx'])) {
            ...
            if (move_uploaded_file($fileTmpName, $newFileName)) {
                    ...
                    $(document).ready(function () {
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                ...
                                setTimeout(function(){ window.location.href="' . ADMIN_URL . '/zipcodes/index.php"; }, 2000);
                ...
                $success_message = 'Zipcodes uploaded successfully';
    ...
    // echo "<script>setTimeout(function(){ window.location.href='" . ADMIN_URL . "/zipcodes'; }, 2000);</script>";
...
<div class="row">
    ...
    <div class="col-12">
        ...
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <h4 class="mb-sm-0">All Zipcodes</h4>
        ...
        <div class="card">
            ...
            <div class="card-body dataTables_wrapper pt-0">
                ...
                <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col float-end text-end">
                            ...
                            <a href="<?php echo ADMIN_URL; ?>zipcodes/add-zipcode.php">

                                <h5 class="card-title btn bg-success text-white">Add New Zipcode</h5>
                ...
                if (isset($_GET['search_term']) && !empty($_GET['search_term'])) {
                    ...
                    $condition = "where zipcode like '%$search%' or city like '%$search%' or state like '%$search%'";
                ...
                <table class="table table-bordered dt-responsive dataTable nowrap table-striped align-middle" style="width: 100%">
                    ...
                    <tbody>
                        ...
                        $total_query = mysqli_fetch_array(mysqli_query($con, "SELECT COUNT(*) FROM `tender_zipcodes` $condition order by `id` DESC "))[0];
                        ...
                        $tenders_data = mysqli_query($con, "SELECT * FROM `tender_zipcodes` $condition order by `id` DESC LIMIT $offset, $limit");
                        ...
                        ?>
                                ...
                                <tr class="<?php if ($i % 2 == 0) {
                                    ...
                                    <td class="action_element">
                                        ...
                                        <a href="<?php echo ADMIN_URL; ?>zipcodes/edit-zipcode.php?id=<?php echo $data['id']; ?>"><i style="font-size: 20px;" class="ri-pencil-fill text-success"></i></a> &nbsp | &nbsp

                                        <a href="<?php echo ADMIN_URL; ?>zipcodes/index.php?id=<?php echo $data['id']; ?>" class="delete" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center"><i style="font-size: 20px;" class="ri-delete-bin-fill text-danger"></i></a>
                            ...
                            <tr class="odd">
                                ...
                                <td colspan="5">No zipcode found.</td>
