...
<?php
$blogs_per = _get_user_perby_role($_SESSION['user_id'],'states',$con);
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <a class="dropdown-item fs-sm" href="<?php echo ADMIN_URL; ?>states/add.php">
                    <h5 class="card-title float-end btn bg-success text-white">Add New States</h5>
                </a>
            ...
            <div class="card-body">
                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $fetching_data = mysqli_query($con, "SELECT * FROM states order by name asc");
                                ...
                                <td>
                                    <div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item edit-item-btn" href="<?php echo ADMIN_URL; ?>states/edit.php?id='<?php echo $row['id']; ?>'"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i>
                                                    Edit</a>
                                            </li>
                                            <li>
