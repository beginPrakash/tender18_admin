                ...
                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%">
                    ...
                    <tbody>
                        ...
                        if(count($cust_keywords) > 0){
                            ...
                            $sql = "SELECT DISTINCT u.company_name, u.users_email, u.user_unique_id,u.mobile_number,u.user_id,u.status,u.user_role FROM users u JOIN cms_customer p ON $conditionStr  where u.user_role='user' and u.status='Upgrade' order by u.user_id desc";
                        }
