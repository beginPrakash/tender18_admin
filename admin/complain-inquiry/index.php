...
?>
<?php $pages = 'complain-inquiry'; ?>
<?php include '../includes/header.php' ?>

<?php
if (isset($_GET['id'])) {
    $del = mysqli_query($con, "DELETE FROM `complain_inquiry_form` where id='" . $_GET['id'] . "'");
    $status = true;
    if ($status) {
...
if (!empty($_SESSION['success'])) {
    ...
    echo "
             <script>
                     setTimeout(function(){
                        window.location.href='" . ADMIN_URL . "/complain-inquiry/index.php';
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">complain Inquiry Form Data</h4>
        </div>
    </div>
</div>
<!-- end page title -->
        ...
        <div class="card">
            <div class="card-body">
                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width: 100%">
                    ...
                    <tbody>
                        <?php
                        $tenders_data = mysqli_query($con, "SELECT * FROM `complain_inquiry_form` order by `id` DESC");
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="action_element">
                                        <a href="<?php echo ADMIN_URL; ?>complain-inquiry/index.php?id=<?php echo $data['id']; ?>" class="delete" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center"><i style="font-size: 20px;" class="ri-delete-bin-fill text-danger delete_btn" data-url="<?php echo ADMIN_URL; ?>complain-inquiry/index.php?id=<?php echo $data['id']; ?>"></i></a>
                                    </td>
                                </tr>
                            <?php $i++;
                            }
