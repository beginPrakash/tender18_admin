<?php
// index_sync.php
// Usage: include this file and call sync_live_tender_by_id($id)
 ...
 */
function sync_live_tender_by_id($id, $live_tenders_index) {

    global $con;

    $sql = "SELECT title, tender_id, ref_no, agency_type, due_date, tender_value, pincode, publish_date, tender_fee, tender_emd, documents, city, state, department, description, tender_type, opening_date FROM tenders_live WHERE id = ? LIMIT 1";
    ...
    try {
        // 1. Index into LIVE TENDERS
        es_index_document($live_tenders_index, $docId, $doc);
