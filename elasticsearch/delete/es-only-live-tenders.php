...
if ($argc < 2) {
    echo "Usage: php es-only-live-tenders.php YYYY-MM-DD [YYYY-MM-DD]\n";
    echo "Example: php es-only-live-tenders.php 2026-05-01 2026-05-28\n";
    exit(1);
}
