<?php
// index_sync.php
// Usage: include this file and call sync_new_tender_by_id($id)
 ...
 */
function sync_new_tender_by_id($id, $index) {

    global $con;

    $sql = "SELECT title, tender_id, ref_no, agency_type, due_date, tender_value, pincode, publish_date, tender_fee, tender_emd, documents, city, state, department, description, tender_type, opening_date FROM tenders_posts WHERE id = ? LIMIT 1";
