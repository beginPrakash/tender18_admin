...
if (isset($_POST['submit'])) {
    ...
    $q1 = "INSERT INTO career_posts(`title`, `job_status`, `description`, `job_profile`, `experience`, `anual_package`, `location`) VALUES ('$title', '$job_status', '$description', '$job_profile', '$experience', '$anual_package', '$location')";
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Add New Job</h4>
        </div>
    </div>
</div>
<!-- end page title -->
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xxl-12 col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="job_status" class="form-control" id="job_status">
                            </div>
                        </div>
                        <div class="col-xxl-12 col-md-12">
                            <div class="col-md-6">
                        ...
                        <div class="col-xxl-12 col-md-12">
                            <div class="col-md-6">
                                ...
                                <textarea rows="5" name="job_profile" class="form-control d-none" id="job_profile"></textarea>
                        ...
                        <div class="col-xxl-12 col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="anual_package" class="form-control" id="anual_package">
                            </div>
                        </div>
                        <div class="col-xxl-12 col-md-12">
                            <div class="col-md-6">
