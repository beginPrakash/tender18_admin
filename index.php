            ...
            <div class="card-body p-3 d-flex gap-3">
              ...
              <div class="flex-grow-1">
                <p class="text-muted mb-2">
                  Facebook
                  <span class="badge bg-success-subtle text-success"><i class="ti ti-arrow-up-right"></i>
                    2.59%</span>
                </p>
                <h6 class="fw-semibold mb-0">
                  <span class="counter-value" data-target="354620">0</span>k
                  <small class="text-muted fw-normal">Visitors</small>
                </h6>
              </div>
            </div>
          </div>
          ...
          <div class="card">
            <div class="card-body p-3 d-flex gap-3">
              ...
              <div class="flex-grow-1">
                ...
                <h6 class="fw-semibold mb-0">
                  <span class="counter-value" data-target="245631">0</span>k
                  <small class="text-muted fw-normal">Visitors</small>
                </h6>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-body p-3 d-flex gap-3">
              ...
              <div class="flex-grow-1">
                <p class="text-muted mb-2">
                  Twitter
                  <span class="badge bg-danger-subtle text-danger"><i class="ti ti-arrow-down-right"></i>
                    1.67%</span>
                </p>
                <h6 class="fw-semibold mb-0">
                  <span class="counter-value" data-target="154832">0</span>k
                  <small class="text-muted fw-normal">Visitors</small>
                </h6>
              </div>
            </div>
          ...
          <div class="card">
            <div class="card-body p-3 d-flex gap-3">
              ...
              <div class="flex-grow-1">
                ...
                <h6 class="fw-semibold mb-0">
                  <span class="counter-value" data-target="489012">0</span>k
                  <small class="text-muted fw-normal">Visitors</small>
                </h6>
              </div>
            </div>
              ...
              <div class="flex-shrink-0">
                <div class="dropdown card-header-dropdown sortble-dropdown">
                  <a class="text-reset dropdown-btn fs-sm" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="fw-semibold text-uppercase">Sort by: </span><span class="text-muted dropdown-title">Source</span>
                    <i class="ti ti-chevron-down ms-1"></i>
                  </a>
                  <div class="dropdown-menu dropdown-menu-end">
                    <button class="dropdown-item sort" data-sort="source">
                      Source
                    </button>
                    <button class="dropdown-item sort" data-sort="impression">
                      Impression
                    </button>
                    <button class="dropdown-item sort" data-sort="cost">
                      Cost
                    </button>
                  </div>
                </div>
                ...
                <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                  <thead class="text-muted table-light">
                    <tr>
                      ...
                      <th scope="col" class="sort cursor-pointer" data-sort="impression">
                        Impression
                      </th>
                      <th scope="col" class="sort cursor-pointer" data-sort="clicks">
                        Clicks
                      </th>
                      <th scope="col" class="sort cursor-pointer" data-sort="cost">
                        Cost
                      </th>
                      <th scope="col" class="sort cursor-pointer" data-sort="conversation">
                        Conversion
                      </th>
                    </tr>
                  </thead>
                ...
                <div class="noresult" style="display: none">
                  <div class="text-center">
                    ...
                    <p class="text-muted mb-0">
                      We've searched more than 150+ transactions We
                      did not find any transactions for you search.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="mx-n3" data-simplebar style="max-height: 478px">
                <div class="d-flex gap-2 mb-3">
                  ...
                  <div class="flex-grow-1">
                    <h6>
                      12.74k
                      <small class="text-muted fw-normal">/Session</small>
                    </h6>
              ...
              <div class="table-responsive table-card mb-0 mt-3">
                <table class="table table-sm table-borderless align-middle text-center mb-0 table-nowrap">
                  <tbody>
                    <tr>
                      <td class="text-start">
                        <i class="ti ti-point-filled align-baseline me-1 text-primary"></i>
                        Total Revenue
                      </td>
                      <th>$795.69k</th>
                      <td class="text-muted">
                        <span class="text-success"><i class="bi bi-caret-up-fill align-baseline me-1"></i>
                          6.19%</span>
                        than last years
                      </td>
                      <td class="text-end" style="width: 150px">
                        <a href="#!" class="icon-link icon-link-hover text-decoration-underline link-underline link-underline-opacity-0 link-underline-opacity-75-hover">View All <i class="bi bi-arrow-right"></i></a>
                      </td>
                    </tr>
                    <tr>
                      <td class="text-start">
                        <i class="ti ti-point-filled align-baseline me-1 text-success"></i>
                        Total Expenses
                      </td>
                      <th>$415.37k</th>
                      <td class="text-muted">
                    ...
                    <tr>
                      <td class="text-start">
                        <i class="ti ti-point-filled align-baseline me-1 text-info"></i>
                        Profit Ratio
                      </td>
                      <th>3.6%</th>
                      <td class="text-muted">
                        <span class="text-danger"><i class="bi bi-caret-down-fill align-baseline me-1"></i>
                          1.47%</span>
                        than last years
                      </td>
                      <td class="text-end" style="width: 150px">
      ...
      <div class="card bg-success-subtle shadow-none rounded-0 border-0 dashboard-widgets-wrapper">
        <div class="card-body text-center mt-5 pt-5">
          ...
          <p class="text-muted fs-md">
            There is the latests update for the last 7 days, check
            now
          </p>
        ...
        <div class="card-body vstack gap-2">
          <div class="d-flex bg-body-secondary rounded">
            ...
            <div class="flex-grow-1 px-3 py-2 overflow-hidden">
              ...
              <p class="text-muted fs-sm text-truncate mb-0">
                This is a periodic meeting between sales and
                marketing aimed at ensuring initial and ongoing
          ...
          <div class="d-flex bg-body-secondary rounded">
            ...
            <div class="flex-grow-1 px-3 py-2 overflow-hidden">
              ...
              <p class="text-muted fs-sm text-truncate mb-0">
                Event banners are one of the many ways to use print
          ...
          <div class="d-flex bg-body-secondary rounded">
            ...
            <div class="flex-grow-1 px-3 py-2 overflow-hidden">
              ...
              <p class="text-muted fs-sm text-truncate mb-0">
                Contact your unhappy customer and be personable. Use
                their first name and apologize as necessary.
              </p>
            </div>
          </div>
          <div class="d-flex bg-body-secondary rounded">
            ...
            <div class="flex-grow-1 px-3 py-2 overflow-hidden">
              ...
              <p class="text-muted fs-sm text-truncate mb-0">
                Ecommerce dashboards aggregate the most important
                performance metrics, so online sellers can track
...
<div class="row">
  ...
  <div class="col-xl-3">
    <div class="card card-height-100">
      ...
      <div class="card-body">
        <h4>
          <span class="counter-value" data-target="5634">0</span>k
        </h4>
        ...
        <div class="row g-4">
          <div class="col-sm-6">
            <div class="card border-4 border-bottom border-primary mb-0">
              <div class="card-body text-center">
                <h6 class="fs-lg mb-2">
                  <span class="counter-value" data-target="1523">0</span>k
                </h6>
          ...
          <div class="col-sm-6">
            <div class="card border-4 border-bottom border-success mb-0">
              <div class="card-body text-center">
                <h6 class="fs-lg mb-2">
                  <span class="counter-value" data-target="1279">0</span>k
                </h6>
          ...
          <div class="col-sm-6">
            <div class="card border-4 border-bottom border-info mb-0">
              <div class="card-body text-center">
                <h6 class="fs-lg mb-2">
                  <span class="counter-value" data-target="1895">0</span>k
                </h6>
          ...
          <div class="col-sm-6">
            <div class="card border-4 border-bottom border-warning mb-0">
              <div class="card-body text-center">
                <h6 class="fs-lg mb-2">
                  <span class="counter-value" data-target="873">0</span>k
                </h6>
  ...
  <div class="col-xl-3">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <h5>
          <span class="counter-value" data-target="2816">0</span>k
        </h5>
        ...
        <div class="d-flex mt-2 align-items-center fs-md">
          <p class="mb-0 flex-grow-1">
            <i class="ti ti-rotate-rectangle fs-xs text-primary"></i>
            Returning
          </p>
          <p class="mb-0">
            <i class="ti ti-rotate-rectangle fs-xs text-success"></i>
            New
          </p>
        </div>
      </div>
